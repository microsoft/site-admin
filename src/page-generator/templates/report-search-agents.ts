    ...
    <div data-sp-canvascontrol="" data-sp-canvasdataversion="1.0"
        ...
        <div data-sp-rte="">
            ...
            <div class="imagePlugin" style="background-color&#58;transparent;position&#58;relative;"
                data-alignment="Center" data-captiontext="Search Agents Settings" data-imagenaturalheight="361"
            ...
            <p class="noSpacingAbove spacingBelow" data-text-type="withSpacing">The report can be run against all sites,
                ...
                from the “List/Library” tab.</p>
            <h4 class="headingSpacingAbove headingSpacingBelow">Report Output&#58;</h4>
            <p class="noSpacingAbove noSpacingBelow" data-text-type="noSpacing">The Search Agents report will find any
                file with the .agent extension to determine if any Copilot agents exist in the site.</p>
        </div>
    </div>
    <div data-sp-canvascontrol="" data-sp-canvasdataversion="1.0"
...
export const ReportSearchAgents = new PageTemplate(CanvasContent, "8a25e50f-a830-4e23-bfd3-38aaa20b57ba",
    "caf33edc-08f1-46f1-be6f-3946a595ebc3", "416cc6dd-2088-4197-91e2-3f6f7b4c6219",
    "/sites/Demo/site-admin/SiteAssets/SitePages/SATAuditReportsSearchAgents", {
